...
CREATE TABLE `product` (
  ...
  `pdClassificationNum` int DEFAULT '0',
  PRIMARY KEY (`pdNum`),
  KEY `fk_idx` (`pdClassificationNum`),
  CONSTRAINT `fk_product_pdClassificationNum` FOREIGN KEY (`pdClassificationNum`) REFERENCES `productclassification` (`pdClassificationNum`)
