...
public class Student {
	// 필드 : 학년, 반, 번호 ,이름, 성적들(과목, 학기, 중간, 기말, 수행평가)->성적들도 클래스로 만들어서 사용할 예정 
	private int grade;
	...
	public boolean addScore(Score score) {
		...
		// 학생의 성적 정보들 중에서 과목, 학기가 같은 성정 정보가 없으면 추가
	...
	// 메소드 : getter/setter, equals() : 같은 객체인지 비교하기 위해, toString() : 객체를 쉽게 문자열로 만들기 위해, 
	public int getGrade() {
		return grade;
	}
