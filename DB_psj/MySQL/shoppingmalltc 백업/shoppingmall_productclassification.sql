...
CREATE TABLE `productclassification` (
  `pdClassificationNum` int NOT NULL,
  `pdClassificationName` varchar(50) NOT NULL,
  PRIMARY KEY (`pdClassificationNum`)
...
LOCK TABLES `productclassification` WRITE;
/*!40000 ALTER TABLE `productclassification` DISABLE KEYS */;
/*!40000 ALTER TABLE `productclassification` ENABLE KEYS */;
UNLOCK TABLES;
